...
const UpdateUser = () => {
 ...
 return (
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      <ToastContainer />
        <MDTypography variant="h2" fontWeight="bold" style={{fontSize: "3rem", marginBottom: "2rem" ,marginTop:"5rem"}} color="#800080">
           Edit User
        </MDTypography>
    
      <div style={{ maxWidth: '400px' }}>
      
      <TableContainer style={{ width: '100%', margin: 'auto' , backgroundColor: "#F8F8FF"}}>
